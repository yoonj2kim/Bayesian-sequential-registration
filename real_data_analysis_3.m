...
%% Set up
load('data/real_data_analysis_3_data.mat','f_mat','t','tG','M','N','M_gamma','nbasis','q_basis','prior_params')
...
prior_params.alpha = 10; prior_params.beta = 0.01; % hyperparameters for \sigma^2
